...
int main(void)
{
  ...
  BSP_LCD_DisplayStringAt(0, 35, (uint8_t *)"LCD Driver example", CENTER_MODE);
  ...
  BSP_LCD_DisplayStringAt(0, BSP_LCD_GetYSize() / 2 + 30, (uint8_t *)"Display String on LCD", CENTER_MODE);
  BSP_LCD_DisplayStringAt(0, BSP_LCD_GetYSize() / 2 + 45, (uint8_t *)"Green LED Start Blinking", CENTER_MODE);
  while(1)
  {
	  BSP_LED_Toggle(LED1);
	  HAL_Delay(200);
