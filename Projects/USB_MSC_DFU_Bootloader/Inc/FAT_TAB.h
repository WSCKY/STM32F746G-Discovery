...
#define FATFS_USED_SIZE                (SECTOR_SIZE * 9)
#define FLASH_USER_SIZE                (200 * 1024)

#define TOTAL_SECTORS                  ((FATFS_USED_SIZE + FLASH_USER_SIZE) / SECTOR_SIZE)
...
static uint8_t FATn_TABLE[FAT_TABLE_SIZE] = {0x00, 0x00, 0x00, 0xFF, 0x0F};//{0x00, 0x00, 0x00, 0x03, 0x40, 0x00, 0xFF, 0x0F};
...
//0x9B, 0x47, 0x9B, 0x47, 0x00, 0x00, 0xB1, 0xA6, 0x9B, 0x47, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	/* TAB - 3 */
//	 'R',  'E',  'A',  'D',  'M',  'E',  ' ',  ' ',  'T',  'X',  'T', FILE_ATTRIBUTES_RWE, RESERVED_BYTE, RESERVED_BYTE, RESERVED_BYTE, RESERVED_BYTE, 
